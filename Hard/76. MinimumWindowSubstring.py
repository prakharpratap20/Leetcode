...
class Solution:
    def minWindow(self, s, t):
        ...
        for rightPointer in range(len(s)):
            ...
            if currentChar in charCountT and charCountWindow[currentChar] == charCountT[currentChar]:
                charsMatched += 1
            ...
            while charsMatched == charsNeeded:
                ...
                if s[leftPointer] in charCountT and charCountWindow[s[leftPointer]] < charCountT[s[leftPointer]]:
                    charsMatched -= 1
                leftPointer += 1
